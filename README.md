...
主仓 [shuiyingjian](https://github.com/mayaxuuu-creator/shuiyingjian) 的小红书容器适配版。当前开发分支代码为 v3.8，发布候选包仍为 `水影笺_小红书_v1.8.zip`。

## 当前功能

- 五套固定组合色盘：青绿、松烟、敦煌、汝窑、中秋限定。
- 每套组合包含纸底、油墨、纹理、装饰、诗句与导出路线，不做自由混搭。
- 长物斋（本机最多 60 件）按斋展、笺架、扇架、签架分区陈列；斋展固定九宫展格，可挑选或点格替换九件；另有成笺 / 素笺切换、三字内自定义刻印。
- 拓后成器：笺 / 团扇 / 书签；团扇使用立架、竹柄、竹圈与流苏的器物化渲染。
